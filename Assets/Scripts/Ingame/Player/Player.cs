...
namespace Shogi.Player
{
    ...
    public class Player : MonoBehaviour
    {
        ...
        /// 自分の駒台
        /// </summary>
        [SerializeField] private Stage.PieceStage _myPieceStage;
        /// <summary>
        /// 成るかの確認を問いかける橋渡しオブジェクト
        /// </summary>
        [SerializeField] private Contact.PromotionDecision _promotionDecision;
        ...
        /// 現在選択中の駒
        /// </summary>
        private Piece.Piece _currentSelectedPiece = null;
        /// <summary>
        /// 現在選択中の駒の移動先候補
        /// </summary>
        ...
        public void OnPieceClicked(Piece.Piece clickedPiece)
        {
            // 駒がクリックされた場合の処理
        ...
        public void OnCellClicked(Stage.StageCell clickedCell)
        {
            // マスがクリックされた場合の処理
        ...
        /// 駒選択待ちの処理
        /// </summary>
        private void HandlePieceSelect(Piece.Piece selectedPiece)
        {
        ...
        private void EnterPieceDestinationSelect()
        {
            ...
            // 選択中の駒の移動先候補を取得
            _currentSelectedPieceDestinationCandidates = Logic.Functions.GetMoveDestinationCandidates(_currentSelectedPiece, _mainStage);
            // 候補先がない場合、駒選択待ちへ遷移
        ...
        /// <returns></returns>
        private IEnumerator MovePieceToDestination(Piece.Piece piece, Vector2Int destination)
        {
            // 移動先に相手の駒があるか確認
            Piece.Piece occupyingPiece = _mainStage.GetPieceAt(destination);
            ...
            var promoteResult = Logic.Functions.CheckPiecePromotable(piece, isFromMainStage, previousPos, destination);
            switch (promoteResult)
            {
                case Logic.Functions.PiecePromoteJudgementType.FORCE_PROMOTE:
                    piece.ChangePromotionState(true);
                    break;
                case Logic.Functions.PiecePromoteJudgementType.SELECTABLE_PROMOTE:
                    ...
                    break;
                case Logic.Functions.PiecePromoteJudgementType.CANT_PROMOTE:
                    // 何もしない
                    break;
                default:
                    // 何もしない
