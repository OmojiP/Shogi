...
public class ClickRaycaster : MonoBehaviour
{
    ...
    /// <returns></returns>
    public bool TryGetClickedPiece(out Piece clickedPiece)
    {
        // outパラメータの初期化
        clickedPiece = null;
    ...
    /// <returns></returns>
    public bool TryGetClickedStageCell(out StageCell clickedCell)
    {
        // outパラメータの初期化
        clickedCell = null;
        ...
        for(int i = 0; i < hits.Length; i++)
        {
            ...
            {
                // StageCellコンポーネントを取得
                clickedCell = hit.collider.GetComponent<StageCell>();
                return true;
            }
        }
